...
public class CommentsActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FeedResponse.Comment test1 = new FeedResponse.Comment("test1", "https://cdn.pixabay.com/photo/2020/03/08/21/41/landscape-4913841_1280.jpg", "게시글 댓글 테스트1", 12, 55, "날짜", 2, repliesTest1);
        FeedResponse.Comment test2 = new FeedResponse.Comment("test2", "https://cdn.pixabay.com/photo/2020/09/02/18/03/girl-5539094_1280.jpg", "게시글 댓글 테스트2", 35, 23, "날짜", 0,  new ArrayList<>());
        FeedResponse.Comment test3 = new FeedResponse.Comment("test3", "https://cdn.pixabay.com/photo/2014/03/03/16/15/mosque-279015_1280.jpg", "게시글 댓글 테스트3", 71, 65, "날짜",0,  new ArrayList<>());
        ...
        Btn_sendComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FeedResponse.Comment test4 = new FeedResponse.Comment("test3", "https://cdn.pixabay.com/photo/2014/03/03/16/15/mosque-279015_1280.jpg",comment , 12, 100, "날짜", 0, new ArrayList<>());
